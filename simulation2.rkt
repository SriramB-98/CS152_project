...
(define minerC (new miner% [nodeidentifier "Adwait"] [computing-power 10]))
(define minerD (new miner% [nodeidentifier "Nitish"] [computing-power 10]))
...
(send minerC add-new-connection nodeB 1)
(send minerC add-new-connection nodeC 1)
(send minerC add-new-connection minerD 1)

(send minerD add-new-connection nodeB 1)
(send minerD add-new-connection nodeC 1)
